...
if __name__ == "__main__":
    # url = input("请输入商品链接:")
    # mall = input("请选择商城（淘宝 1  天猫 2  小米有品 3 输入数字即可）： ")
    # bt = input("请输入开售时间【2019-02-15（空格）12:55:50】")
    url = "https://detail.tmall.com/item.htm?spm=a220m.1000858.1000725.17.402e6cdeANW10a&id=608794217262&skuId=4481032787246&areaId=110100&user_id=2206710179924&cat_id=53314009&is_b=1&rn=5b0b8581fe9a3206cb6c7ef7ecd1fcb7"
    mall = "2"
    bt = "2020-02-07 16:50:50"
    login(url, mall)
    buy(bt, mall)
